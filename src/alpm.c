...
ZEND_BEGIN_ARG_INFO_EX(handle_one_param_architecture, 0, 0, 1)
    ZEND_ARG_INFO(0, architecture)
ZEND_END_ARG_INFO()
...
static zend_function_entry handle_methods[] = {
    ...
    PHP_ME(Handle, get_architectures,      zero_args,                         ZEND_ACC_PUBLIC)
    ...
    PHP_ME(Handle, remove_architecture,    handle_one_param_architecture,     ZEND_ACC_PUBLIC)
...
PHP_MINIT_FUNCTION(alpm) {
    ...
    /* alpm_pkgfrom_t */
    REGISTER_LONG_CONSTANT("ALPM_PKG_FROM_FILE", ALPM_PKG_FROM_FILE, CONST_CS|CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALPM_PKG_FROM_LOCALDB", ALPM_PKG_FROM_LOCALDB, CONST_CS|CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALPM_PKG_FROM_SYNCDB", ALPM_PKG_FROM_SYNCDB, CONST_CS|CONST_PERSISTENT);

    /* alpm_pkgvalidation_t */
    REGISTER_LONG_CONSTANT("ALPM_PKG_VALIDATION_UNKNOWN", ALPM_PKG_VALIDATION_UNKNOWN, CONST_CS|CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALPM_PKG_VALIDATION_NONE", ALPM_PKG_VALIDATION_NONE, CONST_CS|CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALPM_PKG_VALIDATION_MD5SUM", ALPM_PKG_VALIDATION_MD5SUM, CONST_CS|CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALPM_PKG_VALIDATION_SHA256SUM", ALPM_PKG_VALIDATION_SHA256SUM, CONST_CS|CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALPM_PKG_VALIDATION_SIGNATURE", ALPM_PKG_VALIDATION_SIGNATURE, CONST_CS|CONST_PERSISTENT);
